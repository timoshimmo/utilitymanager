          ...
          <div className="w-full flex">
            <Card className="w-2/5 h-30">
              <div className="w-full flex justify-between items-center">
                <span className="text-accent text-sm font-semibold">DISCOS OVERVIEW</span>
            ...
            <Card className="w-3/5 h-30 ml-4">
              <div className="w-full h-full flex justify-between">
                <div className="w-1/2 h-full flex flex-col justify-between">
                  <div className="w-full flex justify-between items-center">
                    <span className="text-accent text-sm font-semibold">ADMINS</span>
                    <CardUpArrowIcon className="w-8 h-8"/>
                  </div>
                  <div className="w-full flex justify-end flex-col">
                    <p className="text-body text-[20px] font-bold">0</p>
                    <span className="text-accent text-xs">TOTAL ACTIVE SUPER ADMINS</span>
                  </div>
                </div>
                <div className="h-full border border-r-1 border-r-[#F0F0F0] mx-4"></div>
                <div className="w-1/2 flex flex-col justify-between">
                  <div className="w-full flex justify-between items-center">
                    <span className="text-accent text-sm font-semibold">USERS</span>
                    <CardUpArrowIcon className="w-8 h-8"/>
                  </div>
                  <div className="w-full flex justify-end flex-col">
                    <p className="text-body text-[20px] font-bold">0</p>
