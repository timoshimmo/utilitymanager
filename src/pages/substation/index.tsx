...
const GetSubstation = () => {
  ...
  const navNew = () => {
      history.push(ROUTES.CREATE_SUBSTATION);
  }
      ...
      <div className="w-full h-full py-10 px-8">
        <div className="w-full flex">
          <Card className="w-2/5 h-[200px] relative">
            <div className="absolute left-[50%]">
              <span className="text-accent text-sm font-bold">STATION OVERVIEW</span>
            </div>
          ...
          <Card className="w-3/5 h-[200px] ml-4">
            <div className="w-full h-full flex justify-between">
              <div className="w-full h-full flex flex-col justify-between">
                <div className="w-full flex justify-between items-center">
                  <span className="text-accent text-sm font-bold">STATION VALUE</span>
                </div>
                <div className="flex flex-wrap" style={{ display: "block" }}>
                  <Chart
        ...
        <div className="flex items-center flex-col bg-[#FFFFFF] shadow rounded mt-4 pt-6 pb-10">
          <div className="w-full flex justify-between items-center px-6">
            <span className="text-lg text-body font-semibold">Substation Table</span>
